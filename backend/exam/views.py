...
class DeleteExamView(APIView):
    ...
    def delete(self, request, exam_code):
        try:
            ...
            return Response({"message": "Exam and related questions successfully deleted."},
...
class UpdateExamQuestionView(APIView):
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter('exam_code', openapi.IN_PATH, description="The unique code of the exam",
                              type=openapi.TYPE_STRING),
            openapi.Parameter('question_id', openapi.IN_PATH, description="The ID of the question to update",
